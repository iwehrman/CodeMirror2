...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    var instance = wrapper.CodeMirror = {
      ...
      lineInfo: lineInfo,
      getVisibleLines: function(top) { return visibleLines(top); },  
    ...
    function updateDisplay(changes, suppressCallback, scrollTop) {
      ...
      for (i = 0; i < inlines.length; i++) {
        ...
        if (!inline.exists()) {
          ...
          var pos = {line: lineNum, ch: Math.max(inline.getLine().text.length - 1, 0)};
    ...
    // commit pending changes without changing the nesting status
    function flush() {
      if (nestedOperation) {
        endOperation();
        startOperation();
